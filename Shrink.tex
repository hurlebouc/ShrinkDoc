...
\newcommand{\ta}{terme algébrique }
\newcommand{\tas}{termes algébriques }
...
%\lhead{ \textit{QUICKCHECK} } 
  %\chead{ }
%\rhead{\textit{Réduction des contre-exemples}}
...
\section{Génération de termes}
	\subsection{Vocabulaire utilisé} \input{generation/voc.tex}
	\subsection{Présentation de l'algorithme} \input{generation/algo.tex}
	
\section{Utilisation des termes générés}\input{utilisation/verif.tex}
	
\section{Réduction des contre-exemples}
