...
\noind On peut interpréter une formule syntaxique issue d'un ensemble de signatures $\S$ et de prédicats $\P$ en lui associant une \textit{interprétation} $I$ qui est la connaissance d'un couple $(\d_I, \ent{\cdot}_I)$ où
\begin{itemize}
...
\noind Une valuation $\sigma$ est une fonction à domaine fini $\{x_1, x_2, \dots,x_n \} \in \X^n$ où les $x_i$ sont deux à deux distinctes, qui associe à chaque $x_i$ un élément de $E \in \d$. On peut alors évaluer un terme.
\begin{itemize}
...
\noind On peut alors définir la validité d'une formule selon l'interprétation $I$ et la valuation $\sigma$, que l'on note $I\valide_\sigma F$.
\begin{itemize}
\item Si $P$ est un symbole de prédicat d'arité $n$ et $ I \valide _\sigma P$
\end{itemize}
