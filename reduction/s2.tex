...
\noind Le second \algo \texttt{s2} est indépendant de \texttt{s1} mais cherche toujours à diminuer la taille de l'élément de départ. Cette fois ci, on raisonne uniquement au niveau de la racine du terme $t$. On cherche tous les constructeur du type dont dérive $t$ qui sont \textit{inclus} dans le constructeur de $t$. Par \textit{inclus}, on veut dire que, si $n_{c,T}$ est le nombre d'argument du constructeur $c$ de type $T$, 
